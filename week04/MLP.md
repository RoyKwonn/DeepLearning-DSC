...
> 이렇게 최종적으로 우리가 원하는 **XOR문제**의 정답이 도출 된걸 볼수가 있었네요  
> 이렇게 은닉층을 여러개 쌓아 올려 복잡한 문제를 해결하는 과정은 앞서 언급드렸던 뉴런이 복잡한  
> 과정을 거쳐 사고를 낳는 사람의 신경망과 유사함을 나타내고 있죠  
> 그래서 이러한 방법을 **인공 신경망**이라 부르기 시작했고 이를 줄여 간단히 신경망이라고 통칭합니다.
